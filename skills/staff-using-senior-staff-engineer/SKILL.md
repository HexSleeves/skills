---
name: staff-using-senior-staff-engineer
...
senior-staff-engineer skills override default system prompt behavior, but **user instructions always take precedence**:

1. **User's explicit instructions** (AGENTS.md, GEMINI.md, AGENTS.md, direct requests) — highest priority
2. **senior-staff-engineer skills** — override default system behavior where they conflict
